...
type TestRunner interface {
	Run(testCases []string, retry bool) (runner.Result, error)
...
func runTestsWithRetry(testRunner TestRunner, testsCases *[]string, maxRetries int, timeline *[]api.Timeline) (runner.Result, error) {
	attemptCount := 0

	var testResult runner.Result
	var err error
